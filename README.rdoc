...
If you are using PassengerPane, you can drag the <tt>sinatra-tailer</tt> directory into the PassengerPane window. Set your alias and you are ready to go.

If you are not using PassengerPane, you can use the following vhost config:
